...
export const characters: RegisteredCharacter[] = [{
  ...
  icon: '🐋',
  color: '#3e719e',
  defaults: { color: '#3e719e', stiffness: 0.48, damping: 0.42 },
  load: async () => (await import('./oceanmochi')).createWhaleMochi,
}, {
  id: 'sharkmochi',
  name: '深海小鲨鱼',
  ...
  icon: '🦈',
  color: '#7294ad',
  defaults: { color: '#7294ad', stiffness: 0.48, damping: 0.42 },
  load: async () => (await import('./oceanmochi')).createSharkMochi,
}];
